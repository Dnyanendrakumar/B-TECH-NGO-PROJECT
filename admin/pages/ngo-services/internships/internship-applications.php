...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary">Volunteer</h6>
    </div>
    <div class="card-body">
    <?php
        ...
        if ($result->num_rows > 0) {
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                if($row['status'] == "pending"){
                    echo '<button class="btn btn-success" onclick="approveApplication(' . $row['id'] . ')">Accept</button>';
