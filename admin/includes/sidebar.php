...
<head>
    ...
    <link rel="stylesheet" src="css/sidebar.css">
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul style="background-color:#1e2436" class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">

            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                
                <div class="sidebar-brand-text mx-3">N G O  Admin </div>
            </a>
            ...
            <li class="nav-item <?= ($activePage == 'messages') ?  'active': '';?>">
                <a class="nav-link " href="messages.php?viewall=1">
                    ...
                    <span style="color:black">Messages</span></a>
            </li>
            ...
            <li class="nav-item <?= ($activePage == 'internships') ?  'active': '';?>">
                ...
                <div id="collapseX" class="collapse <?= ($activePage == 'internships') ?  'show': '';?>" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Manage Volunteer:</h6>
                        <a class="collapse-item <?= ($activeSubPage['viewInternshipApplications'] ?? '') ?  'active': '';?>" href="./internships.php?viewInternshipApplications=1">Volunteer Applications</a>
